...
file_put_contents('/var/www/html/control/debug.log', "Comando ejecutado: " . $command . PHP_EOL, FILE_APPEND);

// Execute the command and log the output
$output = shell_exec($command . ' 2>&1');
file_put_contents('/var/www/html/control/debug.log', "Salida: " . $output . PHP_EOL, FILE_APPEND);
