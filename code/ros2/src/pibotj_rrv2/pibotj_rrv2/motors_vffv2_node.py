...
class MotorsVFFV2Node(Node):
    ...
    def move_motors(self):
        ...
        if self.vff_vel is not None and self.dl_vel is not None:
            
            # Hay bache en cualquier lado
            if self.vff_angular_vel != 0.0:
                # hay línea en la izquierda
                if self.dl_vel.angular.z < 0.0:
