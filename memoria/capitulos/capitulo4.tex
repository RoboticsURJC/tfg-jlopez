...
\footnotetext[\value{footnote}]{\url{https://www.raspberrypi.com/products/raspberry-pi-4-model-b/}\label{note:enlace32}}
...
\footnotetext[\value{footnote}]{\url{https://www.raspberrypi.com/products/camera-module-v2/}\label{note:enlace33}}
...
\footnotetext[\value{footnote}]{\url{https://www.u-blox.com/en/product/neo-6-series}\label{note:enlace34}}
...
\setcounter{footnote}{35} % Reiniciar la numeración de notas al pie
\footnotetext[\value{footnote}]{\url{https://www.parallax.com/product/parallax-standard-servo/}\label{note:enlace35}}
...
\begin{figure}[ht!]
	...
	\begin{minipage}{0.3\linewidth}
			...
			\caption*{\centering Rueda \textit{ActivityBot} $^{\ref{note:enlace36}}$} 
		\end{minipage}
	\hspace{2cm}
	\begin{minipage}{0.28\linewidth}
			\centering
			\includegraphics[width=\linewidth]{figs/wheel2.png}
			\caption*{\centering Rueda azul genérica $^{\ref{note:enlace37}}$} 
		\end{minipage}
...
\footnotetext[\value{footnote}]{\url{https://es.rs-online.com/web/p/accesorios-para-kits-de-desarrollo/8430897?srsltid=AfmBOorv3a6_tQNdqAoKx_21Mn1m2MAum68oApyvr5mq8ExPTuh_CVNy}\label{note:enlace36}}

\setcounter{footnote}{37} % Establecer la numeración de la siguiente nota al pie
\footnotetext[\value{footnote}]{\url{https://es.aliexpress.com/item/1005005145020093.html}\label{note:enlace37}}
...
\footnotetext[\value{footnote}]{\url{https://ams.buy.mi.com/es/item/3202200053?&skupanel=1}\label{note:enlace39}}
...
\footnotetext[\value{footnote}]{\url{https://www.asus.com/es/laptops/for-home/vivobook/vivobook-14-k413/}\label{note:enlace41}}
