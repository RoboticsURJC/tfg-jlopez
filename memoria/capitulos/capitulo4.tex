...
\begin{figure}[ht!]
	...
	\begin{minipage}{0.35\linewidth}
		...
		\caption*{\centering Ros2 Foxy $^{\ref{note:enlace49}}$} %\cite{memnon_image}
	\end{minipage}
	\hspace{2cm}
	% aquí incluir iamgen de Guerrero de terracota
	\begin{minipage}{0.35\linewidth}
		...
		\caption*{\centering Logo Ros2 Humble $^{\ref{note:enlace50}}$} %\cite{gomezguerreros}
	\end{minipage}
...
\setcounter{footnote}{49} % Reiniciar la numeración de notas al pie
\footnotetext[\value{footnote}]{\url{https://docs.ros.org/en/foxy/Installation.html}\label{note:enlace49}}

\setcounter{footnote}{50} % Reiniciar la numeración de notas al pie
\footnotetext[\value{footnote}]{\url{https://docs.ros.org/en/humble/index.html}\label{note:enlace50}}
...
\begin{figure} [h!]
	...
	\end{center}
	\caption{Logo de Gazebo $^{\ref{note:enlace52}}$} 
	\label{fig:gazebo}
\end{figure}\

\setcounter{footnote}{52} % Establecer la numeración de la siguiente nota al pie
\footnotetext[\value{footnote}]{\url{https://gazebosim.org/home}\label{note:enlace52}}
...
\begin{figure} [h!]
	...
	\end{center}
	\caption{Logo de Rviz $^{\ref{note:enlace53}}$} 
	\label{fig:rviz}
\end{figure}\

\setcounter{footnote}{53} % Establecer la numeración de la siguiente nota al pie
\footnotetext[\value{footnote}]{\url{http://wiki.ros.org/rviz}\label{note:enlace53}}
...
\begin{figure} [h!]
	...
	\end{center}
	\caption{Logo de Google Colab $^{\ref{note:enlace56}}$} 
	\label{fig:googlecolab}
\end{figure}\

\setcounter{footnote}{56} % Establecer la numeración de la siguiente nota al pie
\footnotetext[\value{footnote}]{\url{https://colab.research.google.com/}\label{note:enlace56}}
...
\begin{figure} [h!]
	...
	\end{center}
	\caption{Logo de YOLOv8 $^{\ref{note:enlace57}}$} 
	\label{fig:yolov8}
\end{figure}\

\setcounter{footnote}{57} % Establecer la numeración de la siguiente nota al pie
\footnotetext[\value{footnote}]{\url{https://docs.ultralytics.com/es}\label{note:enlace57}}
...
\begin{figure} [h!]
	...
	\end{center}
	\caption{Logo de TensorFlow Lite $^{\ref{note:enlace58}}$} 
	\label{fig:tflite}
\end{figure}\

\setcounter{footnote}{58} % Establecer la numeración de la siguiente nota al pie
\footnotetext[\value{footnote}]{\url{https://ai.google.dev/edge/litert}\label{note:enlace58}}
...
\begin{figure} [h!]
	...
	\end{center}
	\caption{Logo de Open Street Maps $^{\ref{note:enlace60}}$} 
	\label{fig:osm}
\end{figure}\

\setcounter{footnote}{60} % Establecer la numeración de la siguiente nota al pie
\footnotetext[\value{footnote}]{\url{https://www.openstreetmap.org}\label{note:enlace60}}
