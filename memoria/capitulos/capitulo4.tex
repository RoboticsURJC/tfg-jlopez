...
\begin{figure}[ht!]
	...
	\begin{minipage}{0.35\linewidth}
		...
		\caption*{\centering Logo Ros2 Foxy} % $^{\ref{note:enlace54}}$
	\end{minipage}
	\hspace{2cm}
	...
	\begin{minipage}{0.35\linewidth}
		...
		\caption*{\centering Logo Ros2 Humble} % $^{\ref{note:enlace55}}$
	\end{minipage}
