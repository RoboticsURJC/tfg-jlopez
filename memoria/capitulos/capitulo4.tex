...
\footnotetext[\value{footnote}]{\url{https://www.amazon.es/dp/B088LR3488?ref}\label{note:enlace40}}
...
Gracias a todas esas características y para mejorar la detección de baches en tiempo real y solventar las limitaciones de la Raspberry Pi, se ha decidido incluir este componente en el proyecto. Su precio es de unos 65€.
...
\footnotetext[\value{footnote}]{\url{https://coral.ai/products/accelerator/}\label{note:enlace43}}
...
\footnotetext[\value{footnote}]{\url{https://buy.mi.com/es/item/3202200053}\label{note:enlace44}}
...
\footnotetext[\value{footnote}]{\url{https://www.amazon.es/dp/B0BZZCJJT8?ref=cm_sw_r_mwn_dp_N64JV6SGENWN4YPSD849&ref_=cm_sw_r_mwn_dp_N64JV6SGENWN4YPSD849&social_share=cm_sw_r_mwn_dp_N64JV6SGENWN4YPSD849&language=es-ES}\label{note:enlace45}}
...
\footnotetext[\value{footnote}]{\url{https://www.asus.com/es/laptops/for-home/vivobook/vivobook-14-k413/}\label{note:enlace46}}
...
\footnotetext[\value{footnote}]{\url{https://www.freecad.org/}\label{note:enlace47}}
...
\footnotetext[\value{footnote}]{\url{https://es.python.org/}\label{note:enlace48}}
...
\footnotetext[\value{footnote}]{\url{https://opencv.org/}\label{note:enlace49}}
...
\footnotetext[\value{footnote}]{\url{https://ubuntu.com/}\label{note:enlace50}}
...
\begin{figure}[ht!]
	...
	\begin{minipage}{0.35\linewidth}
		...
		\caption*{\centering Ros2 Foxy $^{\ref{note:enlace53}}$} %\cite{memnon_image}
	\end{minipage}
	\hspace{2cm}
	...
	\begin{minipage}{0.35\linewidth}
		...
		\caption*{\centering Logo Ros2 Humble $^{\ref{note:enlace54}}$} %\cite{gomezguerreros}
	\end{minipage}
...
\setcounter{footnote}{53} % Reiniciar la numeración de notas al pie
\footnotetext[\value{footnote}]{\url{https://docs.ros.org/en/foxy/Installation.html}\label{note:enlace53}}

\setcounter{footnote}{54} % Reiniciar la numeración de notas al pie
\footnotetext[\value{footnote}]{\url{https://docs.ros.org/en/humble/index.html}\label{note:enlace54}}
...
\setcounter{footnote}{56} % Establecer la numeración de la siguiente nota al pie
\footnotetext[\value{footnote}]{\url{https://gazebosim.org/home}\label{note:enlace56}}
...
\footnotetext[\value{footnote}]{\url{http://wiki.ros.org/rviz}\label{note:enlace57}}
...
\footnotetext[\value{footnote}]{\url{https://colab.research.google.com/}\label{note:enlace60}}
...
\footnotetext[\value{footnote}]{\url{https://docs.ultralytics.com/es}\label{note:enlace61}}
...
\footnotetext[\value{footnote}]{\url{https://ai.google.dev/edge/litert}\label{note:enlace62}}
...
\setcounter{footnote}{64} % Establecer la numeración de la siguiente nota al pie
\footnotetext[\value{footnote}]{\url{https://www.openstreetmap.org}\label{note:enlace64}}
