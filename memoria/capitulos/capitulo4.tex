...
\footnotetext[\value{footnote}]{\url{https://www.raspberrypi.com/products/raspberry-pi-4-model-b/}\label{note:enlace34}}
...
\footnotetext[\value{footnote}]{\url{https://www.raspberrypi.com/products/camera-module-v2/}\label{note:enlace35}}
...
\footnotetext[\value{footnote}]{\url{https://www.amazon.es/dp/B088LR3488?ref}\label{note:enlace36}}
...
\begin{figure}[ht!]
	...
	\begin{minipage}{0.2\linewidth}
		...
		\caption*{\centering Parallax $^{\ref{note:enlace37}}$} %\cite{memnon_image}
	\end{minipage}
	\hspace{2cm}
	...
	\begin{minipage}{0.33\linewidth}
		...
		\caption*{\centering YIDI $^{\ref{note:enlace38}}$} %\cite{gomezguerreros}
	\end{minipage}
...
\footnotetext[\value{footnote}]{\url{https://www.parallax.com/product/parallax-standard-servo/}\label{note:enlace37}}

\setcounter{footnote}{38} % Reiniciar la numeración de notas al pie
\footnotetext[\value{footnote}]{\url{https://es.aliexpress.com/item/1005004551539283.html?spm=a2g0o.productlist.main.15.bee4rd8Srd8SSO&algo_pvid}\label{note:enlace38}}
...
\footnotetext[\value{footnote}]{\url{https://es.rs-online.com/web/p/accesorios-para-kits-de-desarrollo/8430897?srsltid=AfmBOorv3a6_tQNdqAoKx_21Mn1m2MAum68oApyvr5mq8ExPTuh_CVNy}\label{note:enlace39}}
...
\footnotetext[\value{footnote}]{\url{https://coral.ai/products/accelerator/}\label{note:enlace40}}
...
\footnotetext[\value{footnote}]{\url{https://buy.mi.com/es/item/3202200053}\label{note:enlace41}}
...
\footnotetext[\value{footnote}]{\url{https://www.amazon.es/dp/B0BZZCJJT8?ref=cm_sw_r_mwn_dp_N64JV6SGENWN4YPSD849&ref_=cm_sw_r_mwn_dp_N64JV6SGENWN4YPSD849&social_share=cm_sw_r_mwn_dp_N64JV6SGENWN4YPSD849&language=es-ES}\label{note:enlace42}}
...
\footnotetext[\value{footnote}]{\url{https://www.asus.com/es/laptops/for-home/vivobook/vivobook-14-k413/}\label{note:enlace43}}
...
\footnotetext[\value{footnote}]{\url{https://www.freecad.org/}\label{note:enlace44}}
...
\footnotetext[\value{footnote}]{\url{https://es.python.org/}\label{note:enlace45}}
...
\footnotetext[\value{footnote}]{\url{https://opencv.org/}\label{note:enlace46}}
...
\footnotetext[\value{footnote}]{\url{https://ubuntu.com/}\label{note:enlace47}}
...
\begin{figure}[ht!]
	...
	\begin{minipage}{0.35\linewidth}
		...
		\caption*{\centering Ros2 Foxy $^{\ref{note:enlace50}}$} %\cite{memnon_image}
	\end{minipage}
	\hspace{2cm}
	% aquí incluir iamgen de Guerrero de terracota
	\begin{minipage}{0.35\linewidth}
		...
		\caption*{\centering Logo Ros2 Humble $^{\ref{note:enlace51}}$} %\cite{gomezguerreros}
	\end{minipage}
...
\setcounter{footnote}{50} % Reiniciar la numeración de notas al pie
\footnotetext[\value{footnote}]{\url{https://docs.ros.org/en/foxy/Installation.html}\label{note:enlace50}}

\setcounter{footnote}{51} % Reiniciar la numeración de notas al pie
\footnotetext[\value{footnote}]{\url{https://docs.ros.org/en/humble/index.html}\label{note:enlace51}}
...
\footnotetext[\value{footnote}]{\url{https://gazebosim.org/home}\label{note:enlace53}}
...
\footnotetext[\value{footnote}]{\url{http://wiki.ros.org/rviz}\label{note:enlace54}}
...
\footnotetext[\value{footnote}]{\url{https://colab.research.google.com/}\label{note:enlace57}}
...
\footnotetext[\value{footnote}]{\url{https://docs.ultralytics.com/es}\label{note:enlace58}}
...
\footnotetext[\value{footnote}]{\url{https://ai.google.dev/edge/litert}\label{note:enlace59}}
...
\footnotetext[\value{footnote}]{\url{https://www.openstreetmap.org}\label{note:enlace61}}
