...
En los últimos años se ha podido notar un gran progreso en el desarrollo y la implementación de sistemas robóticos de campo. Por otro lado, hay que tener en cuenta que debido a que este tipo de robots operan en exteriores, es complicado determinar su posición y es materia de estudio. Para ello se usa una combinación de tecnología GPS y de odometría para hacer más precisa su posición. En la figura \ref{fig:robcampo} se pueden ver ejemplos al respecto. 
