...
Los prototipos nombrados anteriormente suelen ser demostradores tecnológicos que se crean para exhibiciones, se encuentran a la vanguardia de la tecnología y sirven para atraer un mayor número de clientes como puede ser: Spot de Boston Dynamics, Pepper de Softbank o Sophia de Hanson Robotics. En la figura \ref{fig:robeducativo} (derecha) se pueden ver un ejemplo de estos demostradores.
...
%\begin{figure}[h]
%	\centering
%	\includegraphics[width=0.5\textwidth]{figs/gama-baja.png}  % Sustituye con la ruta de tu imagen
%	\caption{\href{https://www.uclm.es/noticias/febrero2019/toledo/finalfirstlegoleague}{Competición FLL Toledo}}  % URL debajo de la imagen
%	\label{fig:robeducativo}
%\end{figure}
%\begin{figure}[ht!]
%	\centering
	%\begin{minipage}{0.3\linewidth}
		%\centering´
		%\includegraphics[width=\linewidth]{figs/gama-baja.png}
		%\caption*{\centering Competición FLL Toledo}
	%\end{minipage}
	%\hspace{3cm}
	%\begin{minipage}{0.3\linewidth}
	%	\centering
...
%		\centering
%		\includegraphics[width=\linewidth]{figs/FLL_TO19.jpg}
%		\caption{Competición FLL ganadores Toledo}
%		\label{fig:robeducativo}
%	\end{subfigure}
	%\hspace{1.5cm}
	%\begin{subfigure}[b]{0.4\linewidth}
	%    \centering
	%    \includegraphics[width=\linewidth]{figs/irb.jpg}
	%    \caption{ABB IRB 6700}
	%    \label{fig:irb6700}
	%\end{subfigure}
%	\caption{Robots de entretenimiento}
%\end{figure}

%Competición FLL ganadores Toledo\footnote{\url{https://www.uclm.es/noticias/febrero2019/toledo/finalfirstlegoleague}}
