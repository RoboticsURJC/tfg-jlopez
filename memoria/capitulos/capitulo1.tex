...
\begin{figure}[ht!]
	...
	\begin{minipage}{0.4\linewidth}
		...
		\caption*{Brazo robot IRB 140 $^{\ref{note:enlace5}}$.}
...
\begin{figure}[ht!]
	...
	\begin{minipage}{0.35\linewidth}
		...
		\caption*{\centering \ac{FLL} Toledo $^{\ref{note:enlace9}}$}
	\end{minipage}
	\hspace{3cm}
	...
	\begin{minipage}{0.3\linewidth}
		...
		\caption*{\centering Spot de Boston Dynamics $^{\ref{note:enlace10}}$}
	\end{minipage}
...
\footnotetext[\value{footnote}]{\url{https://www.uclm.es/noticias/febrero2019/toledo/finalfirstlegoleague}\label{note:enlace9}}


\setcounter{footnote}{10} % Establecer la numeración de la siguiente nota al pie
\footnotetext[\value{footnote}]{\url{https://bostondynamics.com/products/spot/}\label{note:enlace10}}
...
\begin{figure}[ht!]
	...
	\begin{minipage}{0.5\linewidth}
		...
		\caption*{\centering Robot Da Vinci $^{\ref{note:enlace11}}$}
	\end{minipage}
    \hspace{1 cm}
	...
	\begin{minipage}{0.15\linewidth}
		...
		\caption*{\centering Robot Mako $^{\ref{note:enlace12}}$}
	\end{minipage}
    \hspace{3cm}
    \begin{minipage}{0.2\linewidth}
    	\centering
    	\includegraphics[width=\linewidth]{figs/marsi.png}
    	\caption*{\centering Marsi Bionics $^{\ref{note:enlace13}}$}
    \end{minipage}
    \hspace{3cm}
    \begin{minipage}{0.25\linewidth}
    	\centering
    	\includegraphics[width=\linewidth]{figs/cyberdyne.jpg}
    	\caption*{\centering CyberDyne $^{\ref{note:enlace14}}$}
    \end{minipage}
...
\footnotetext[\value{footnote}]{\url{https://www.abexsl.es/es/sistema-robotico-da-vinci/que-es}\label{note:enlace11}}

\setcounter{footnote}{12} % Establecer la numeración de la siguiente nota al pie
\footnotetext[\value{footnote}]{\url{https://www.stryker.com/content/dam/stryker/joint-replacement/systems/mako-system-overview/resources}\label{note:enlace12}}

\setcounter{footnote}{13} % Establecer la numeración de la siguiente nota al pie
\footnotetext[\value{footnote}]{\url{https://www.marsibionics.com/}\label{note:enlace13}}

\setcounter{footnote}{14} % Establecer la numeración de la siguiente nota al pie
\footnotetext[\value{footnote}]{\url{https://www.cyberdyne.com/}\label{note:enlace14}}
...
\begin{figure}[ht!]
	...
	\begin{minipage}{0.3\linewidth}
		...
		\caption*{\centering Skypod de Exotec $^{\ref{note:enlace15}}$ }
	\end{minipage}
	\hspace{3cm}
	...
	\begin{minipage}{0.3\linewidth}
		...
		\caption*{\centering Amazon Prime Air $^{\ref{note:enlace16}}$}
	\end{minipage}
...
\footnotetext[\value{footnote}]{\url{https://exotecbydexter.com/skypod/}\label{note:enlace15}}


\setcounter{footnote}{16} % Establecer la numeración de la siguiente nota al pie
\footnotetext[\value{footnote}]{\url{https://www.aboutamazon.es/noticias/innovacion/prime-air}\label{note:enlace16}}
...
\begin{figure}[ht!]
	...
	\begin{minipage}{0.3\linewidth}
		...
		\caption*{\centering TX Robotic Strawberry Harvester $^{\ref{note:enlace17}}$ }
	\end{minipage}
	\hspace{3 cm}
	% aquí incluir imagen de  mako
	\begin{minipage}{0.3\linewidth}
		...
		\caption*{\centering FrontRunner Autonomous Haulage System (AHS) $^{\ref{note:enlace18}}$ }
	\end{minipage}
	\hspace{3cm}
	\begin{minipage}{0.3\linewidth}
		\centering
		\includegraphics[width=\linewidth]{figs/tello.png}
		\caption*{\centering Drone Tello $^{\ref{note:enlace19}}$ }
	\end{minipage}
	\hspace{3cm}
	\begin{minipage}{0.3\linewidth}
		\centering
		\includegraphics[width=\linewidth]{figs/perseverance.jpg}
		\caption*{\centering Perseverance $^{\ref{note:enlace20}}$ }
	\end{minipage}
...
\footnotetext[\value{footnote}]{\url{https://advanced.farm/technology/strawberry-harvester/}\label{note:enlace17}}

\setcounter{footnote}{18} % Establecer la numeración de la siguiente nota al pie
\footnotetext[\value{footnote}]{\url{https://www.komatsu.com/en/technology/smart-mining/loading-and-haulage/autonomous-haulage-system/}\label{note:enlace18}}
\setcounter{footnote}{19} % Establecer la numeración de la siguiente nota al pie
\footnotetext[\value{footnote}]{\url{https://www.ryzerobotics.com/es/tello}\label{note:enlace19}}
\setcounter{footnote}{20} % Establecer la numeración de la siguiente nota al pie
\footnotetext[\value{footnote}]{\url{https://es.wikipedia.org/wiki/Perseverance}\label{note:enlace20}}
