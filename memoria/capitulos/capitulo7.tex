...
En este capítulo se tratarán los diferentes experimentos llevados a cabo para la realización de este proyecto.  y la consecución del objetivo final 
...
Imagen con todos los parámetros

Dsitintas versiones que se hizo 

detect.tflite (v1 CPU)
detect\_edgetpu.tflite (v1 convertida pero que sigue usando CPU)
best\_...edge.tflite  (v2 muy pesada usando edge tpu pero que NO VA)
bestv2\_...edge.tflite (V2 funcional que usa imágenes 192x192) 


media movil exponencial (incluir alguna gráfica) y compararlo con otros medios como puede ser filtro de kalman (darle una vuelta a esto)
...
Video de cómo detecta las líneas (con la velocidad original NO CON LOS VALORES DESPACIOS DEL VIDEO ANTIGUO)
...
Video  y capturas del ejemplo creado
\subsection{Autónomo}
Vídeo y capturas del ejemplo creado



Cómo se enlazan internamente 
(diagrama de todos los nodos creados)
