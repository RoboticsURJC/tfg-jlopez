...
\begin{figure} [h!]
	\begin{center}
		\includegraphics[width=8cm]{figs/cap5/hama.png}
	\end{center}
...
- Ruedas azules: se tiene que hacer un agujero de 6mm para que el tornillo del motor entre y unos agujeros de 2mm para que los topes del motor puedan atornillarse bien (incluir fotos)   (foto con las ruedas azules y google coral)
 ...
 1 pieza de cada una de las expuestas anteriormente(todas han usado las mismas características de impresión)
...
Finalmente , para resumir los materiales usados y el precio asociado son: .... como muestra el cuadro


IMAGEN FINAL COMPLETA con los 2 tipos de ruedas \\\\\\


EXplicar la intro del siguiente capítulo \\ 
