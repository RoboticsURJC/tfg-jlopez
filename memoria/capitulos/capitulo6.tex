...
El nombre de este algoritmo es debido al constante cruce de productos de las coordenadas, que simula atarse los cordones, como muestra la Ecuación \ref{ec:shoelace}.
\begin{myequation}[h]
	\begin{equation}
