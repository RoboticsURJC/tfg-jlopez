...
% \begin{figure} [h!]
%	\begin{center}
%		\includegraphics[width=6cm]{figs/cap6/localizacion.png}
%	\end{center}
...
\setcounter{footnote}{109} % Reiniciar la numeración de notas al pie
\footnotetext[\value{footnote}]{\url{https://es.wikipedia.org/wiki/C\%C3\%A1mara_estenopeica}\label{note:enlace109}}
...
%El resultado final aparece en la Figura \ref{fig:carreteracartulina}.
