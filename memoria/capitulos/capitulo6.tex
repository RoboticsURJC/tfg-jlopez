...
Para poner en funcionamiento el modelo, únicamente hay que escribir los siguientes comandos: 

La primera vez que se decide lanzar el modelo, es común que surja algún error por lo tanto, hayy que reiniciarlo.

En una ventana aparte, se puede comprobar todos los topics en funcionamiento 

comando 

(captura de pantalla)

Si se quiere ver cómo se mueve el robot se puede usar 


ros2 topic pub, ros2 teleop, ros\_robot\_steering


Si se quiere ver qué está emitiendo la pantalla 

comando y captura de pantalla 


Si se quiere ver los valores que devuelve el gps

comando y captura de pantalla


En este video se puede ver el funcionamiento completo de PiBotJ en simulación, y ya se puede pasar al dar soporte al robot físico
